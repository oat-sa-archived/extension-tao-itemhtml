...
$GLOBALS['__l10n']["Add a zip containing an OWI"]="新增一個持有 OWI 的ZIP壓縮檔案";
...
$GLOBALS['__l10n']["An Open Web Item package must contain an index.html file at the root of the archive."]="一個 Open Web 題目包的根存檔必須要有一個 index.html 檔案。";
$GLOBALS['__l10n']["An unexpected error occured during the OWI Item import."]="在匯入 OWI 題目時發生了未預料到的錯誤。";
...
$GLOBALS['__l10n']["Disable validation"]="禁用驗證";
...
$GLOBALS['__l10n']["Export "]="匯出";
$GLOBALS['__l10n']["Export an Open Web Item"]="匯出一個 Open Web 題目";
...
$GLOBALS['__l10n']["Import "]="匯入";
$GLOBALS['__l10n']["Import an Open Web Item"]="匯入一個 Open Web 題目";
$GLOBALS['__l10n']["Import Content"]="匯入內容";
...
$GLOBALS['__l10n']["Open Web Item"]="Open Web 題目";
...
$GLOBALS['__l10n']["The OWI Item was successfully imported."]="OWI(Open Web 題目)已成功匯入。";
...
$GLOBALS['__l10n']["The ZIP archive containing the Open Web Item could not be open."]="包含OWI(Open Web 題目)的ZIP壓縮檔無法開啟。";
...
$GLOBALS['__l10n']["This Open Web Item already has content. Go to Preview to see it or import a replacement below."]="這個(OWI)Open Web題目已有內容。 請看預覽或從以下匯入替代題目。";
...
$GLOBALS['__l10n']["Validation of the imported file has failed"]="匯入的檔案驗證失敗";
$GLOBALS['__l10n']["Validation of the imported package has failed"]="匯入的檔案包驗證失敗";
